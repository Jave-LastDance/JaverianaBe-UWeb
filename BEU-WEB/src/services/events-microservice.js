...
export function toServiceEvent(data) {
  ...
  data.date_start_post = new Date(data.startPost);
  data.date_start_post.setDate(data.date_start_post.getDate() + 1);
  data.date_start_post = data.date_start_post.toISOString().split('T')[0];
  ...
  const EditEvent = {
    ...
    date_start_post: data.date_start_post,
