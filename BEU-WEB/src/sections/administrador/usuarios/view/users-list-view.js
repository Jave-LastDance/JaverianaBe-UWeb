                  ...
                  icon={
                    <Label
                      ...
                      color={
                        ...
                        (tab.value === 'CAPS' && 'warning') ||
                        (tab.value === 'CFICC' && 'warning') ||
                        (tab.value === 'CPSFJ' && 'default') ||
                        'default'
                      }
                    >
                      {tab.value === 'all' && users.length}
                      {tab.value === 'CJFD' &&users.filter((user) => user.center === 'CJFD').length}

                      {tab.value === 'CGC' && users.filter((user) => user.center === 'CGC').length}
                      {tab.value === 'BE-U' && users.filter((user) => user.center === 'BE-U').length}
                      {tab.value === 'CAPS' && users.filter((user) => user.center === 'CAPS').length}
                      {tab.value === 'CFICC' && users.filter((user) => user.center === 'CFICC').length}
                      {tab.value === 'CPSFJ' && users.filter((user) => user.center === 'CPSFJ').length}
                    </Label>
                  }
                />
              ))}
