    ...
    <>
      ...
      >
        {stateOptions.map((option) => (
          ...
          >
            {option.value === 'activo' && <Iconify icon="eva:cloud-upload-fill" />}
            {option.value === 'borrador' && <Iconify icon="solar:file-text-bold" />}
            {option.value === 'cancelado' && <Iconify icon="eva:shield-off-fill" />}
            {option.value === 'desactivado' && <Iconify icon="eva:bell-off-fill" />}
            {option.label}
          </MenuItem>
        ))}
      </CustomPopover>
