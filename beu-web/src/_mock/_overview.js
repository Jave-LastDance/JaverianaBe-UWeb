...
export const _appRelated = ['Evento 1', 'Evento 2', 'Evento 3', 'Evento 4', 'Evento 5'].map(
  (name, index) => {
    ...
    const shortcut =
      (name === 'Evento 1' && '/assets/icons/app/ic_chrome.svg') ||
      (name === 'Evento 2' && '/assets/icons/app/ic_drive.svg') ||
      (name === 'Evento 3' && '/assets/icons/app/ic_dropbox.svg') ||
      (name === 'Evento 4' && '/assets/icons/app/ic_evernote.svg') ||
...
export const _appInstalled = ['Medicina', 'Derecho', 'Ing. Industrial', 'Com. Social', 'Psicología','Economía', 'Diseño Gráfico', 'Arquitectura'].map(
  (name, index) => ({
    id: _mock.id(index),
    name,
    ...
    flag: ['flagpack:de', 'flagpack:gb-nir', 'flagpack:fr', 'flagpack:kr', 'flagpack:us', 'flagpack:co', 'flagpack:it', 'flagpack:es'][index],
  })
);
