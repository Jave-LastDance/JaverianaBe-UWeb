...
export const title = [
  'Aplica Estas 7 Técnicas Secretas Para Mejorar un Evento',
'Creer Estos 7 Mitos Acerca del Evento Te Impide Crecer',
'¡No Pierdas Tiempo! 7 Hechos Hasta Que Alcances Tu Evento',
'Cómo 7 Cosas Cambiarán la Forma en que Abordas un Evento',
'Premios del Evento: 7 Razones Por las que No Funcionan y lo que Puedes Hacer al Respecto',
'Un Evento no Tiene por Qué Ser Difícil. Lee Estos 7 Consejos',
'Un Evento es tu Peor Enemigo. 7 Maneras de Derrotarlo',
'Un Evento con un Presupuesto: 7 Consejos de la Gran Depresión',
'Conocer Estos 7 Secretos Hará que tu Evento Luzca Asombroso',
'Domina el Arte del Evento con Estos 7 Consejos',
];

export const sentence = [
  `¡Increíble experiencia, no me lo esperaba!`,
  `Una jornada educativa espectacular, aprendí muchísimo.`,
  `Me encantó la organización y los temas presentados.`,
  `Una oportunidad genial para conocer a otros estudiantes.`,
  `Gran oportunidad para expandir mi red de contactos.`,
  `Realmente inspirador, me fui con muchas ideas nuevas.`,
  `Los ponentes eran expertos en sus campos, impresionante.`,
  `Estoy deseando que llegue el próximo evento de la universidad.`,
  `Una experiencia que no olvidaré, ¡gracias por organizarlo!`,
  `Las actividades complementarias fueron entretenidas y enriquecedoras.`,
  `Me siento agradecido por haber tenido la oportunidad de asistir.`,
  `Valió cada minuto, definitivamente lo recomendaría a otros.`,
  `Me gustó cómo se abordaron temas relevantes y actuales.`,
  `La diversidad de temas tratados fue muy interesante.`,
  `Una experiencia que enriqueció mi perspectiva académica.`,
  `Un evento que cumplió y superó mis expectativas.`,
  `Realmente disfruté de cada charla y taller.`,
  `¡Bravo! La universidad realmente sabe cómo organizar eventos.`,
  `Conocer a expertos en el campo me inspiró a seguir adelante.`,
  `Aprendí tanto en tan poco tiempo, ¡increíble!`,
  `Fue un honor ser parte de esta jornada de aprendizaje.`,
  `Los organizadores merecen un gran aplauso por este evento.`,
  `Las reseñas positivas no son suficientes para expresar mi gratitud.`,
  `¡Qué experiencia tan enriquecedora! Gracias por la oportunidad.`,
  `Espero que este evento se convierta en una tradición anual.`,
  `Definitivamente un evento que deja huella.`,
  `El evento cumplió su objetivo y mucho más.`,
  `Fue más allá de lo que esperaba, ¡muy bien hecho!`,
  `Saliendo con nuevas ideas y una actitud inspirada.`,
  `Un evento que promovió el aprendizaje y la interacción.`,
  `Gracias por este evento que marcó la diferencia en mi educación.`,
];
