...
const _mock = {
  ...
  number: {
    ...
    price: (index: number) => price[index]*100,
  },
  image: {
    cover: (index: number) => `${HOST_API}/assets/images/covers/cover_${index + 1}.jpg`,
    product: (index: number) => `${HOST_API}/assets/images/products/product_${index}.jpg`,
    avatar: (index: number) => `${HOST_API}/assets/images/avatars/avatar_${index}.jpg`,
  },
};
